...
def modelvstrue(x1a, y1a, y1b, title="", xlabel="", ylabel="", colour1='#1984c5', colour2='#76c68f', marker1='.', marker2='.'):
    ...
    plt.title('Model Distances vs True Distances') 
    plt.legend()
    plt.show()


def accfunction(x2a, y2a, y2b, title="", xlabel="", ylabel="", colour1='#1984c5', colour2='#76c68f', marker1='.', marker2='.'):
...
### Percentage Accuracy vs Distance Graphs ###
...
accfunction(x2a, y2a, y2b, title="DS BLG Fundamental Percentage Accuracy % Vs True Distance", xlabel="True Distance", ylabel="Accuracy% (Modeldist/Truedist)")
...
accfunction(x2a, y2a, y2b, title="DS DISK Fundamental Percentage Accuracy % Vs True Distance", xlabel="True Distance", ylabel="Accuracy% (Modeldist/Truedist)")
...
accfunction(x2a, y2a, y2b, title="DS BLG FirstOvertone Percentage Accuracy % Vs True Distance", xlabel="True Distance", ylabel="Accuracy% (Modeldist/Truedist)")
...
accfunction(x2a, y2a, y2b, title="DS DISK FirstOvertone Percentage Accuracy % Vs True Distance", xlabel="True Distance", ylabel="Accuracy% (Modeldist/Truedist)")
...
accfunction(x2a, y2a, y2b, title="CEPH BLG Fundamental Percentage Accuracy % Vs True Distance", xlabel="True Distance", ylabel="Accuracy% (Modeldist/Truedist)")
...
accfunction(x2a, y2a, y2b, title="CEPH DISK Fundamental Percentage Accuracy % Vs True Distance", xlabel="True Distance", ylabel="Accuracy% (Modeldist/Truedist)")
...
accfunction(x2a, y2a, y2b, title="CEPH BLG FirstOvertone Percentage Accuracy % Vs True Distance", xlabel="True Distance", ylabel="Accuracy% (Modeldist/Truedist)")
...
accfunction(x2a, y2a, y2b, title="CEPH DISK FirstOvertone Percentage Accuracy % Vs True Distance", xlabel="True Distance", ylabel="Accuracy% (Modeldist/Truedist)")
